...
var AudioLayer = /** @class */ (function () {
    function AudioLayer(id, source, start, duration, fade) {
        if (fade === void 0) { fade = {}; }
        this.source = source;
    ...
    Object.defineProperty(AudioLayer.prototype, "durationSeconds", {
        get: function () {
    ...
    AudioLayer.prototype.fadeDurationSeconds = function (direction) {
        return moment.duration("00:" + this.fade[direction]).asSeconds();
    };
    AudioLayer.prototype.setup = function () {
    ...
    AudioLayer.prototype.addTo = function (project) {
        var _this = this;
        project = project.input(this.localSource)
            .seekInput(this.start)
            .duration(this.duration);
        var duration = this.durationSeconds;
        return Object.keys(this.fade).reduce(function (proj, dir) {
            var fadeDuration = _this.fadeDurationSeconds(dir);
