        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, Promise.all(this.layers.map(function (l) { return l.setup(); }))];
                                case 1:
                                    _a.sent();
                                    project = this.layers.reduce(function (proj, l) { return l.addTo(proj); }, this.project)
                                        .videoBitrate(20000)
                                        .videoCodec('libx264')
                                        .audioCodec('aac')
                                        .outputOptions([
